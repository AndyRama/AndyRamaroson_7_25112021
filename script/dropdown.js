...
document.querySelectorAll(".filters__dropDown").forEach((btn) =>
  btn.addEventListener("click",(e) => {
    ...
    if (btn.getAttribute("aria-controls") == "ingredientsContainer") {
      inputIng.classList.add("btn-Expansed");
    }

    if (btn.getAttribute("aria-controls") == "deviceContainer") {
      inputDev.classList.add("btn-Expansed");
    }

    if (btn.getAttribute("aria-controls") == "ustensilsContainer") {
